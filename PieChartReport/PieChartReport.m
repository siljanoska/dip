...
@interface PieChartReport ()

@property (strong) NSArray *objectCat;

@end

@implementation PieChartReport
...
- (void)viewDidLoad {
    ...
    [self.pieChartExpense renderInLayer1: self.pieChartExpense dataArray:dataArray nameArray:categoryName];
}
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    [self.pieChartExpense renderInLayer1: self.pieChartExpense dataArray:dataArray nameArray:categoryName];
    [self.view addSubview:self.pieChartExpense];
...
- (IBAction)pressExpenseBtn:(id)sender {
    ...
    [self.pieChartIncome removeFromSuperview];
    [self.pieChartExpense renderInLayer1: self.pieChartExpense dataArray:dataArray nameArray:categoryName];
    [self.view addSubview:self.pieChartExpense];
...
- (IBAction)pressIncomeBtn:(id)sender {
    ...
    [self.pieChartExpense removeFromSuperview];
    [self.pieChartIncome renderInLayer1: self.pieChartIncome dataArray:dataArray nameArray:categoryName];
    [self.view addSubview:self.pieChartIncome];
}
