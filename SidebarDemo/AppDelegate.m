...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    */
    ...
    NSString *storePath = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"Lorien.sqlite"];
    ...
    if (![_persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:storeUrl options:options error:&error]) {
        ...
        if ([[NSFileManager defaultManager] fileExistsAtPath:storePath]) {
            //error occurs when old database has different structure that the one in CoreDataModel
            [[NSFileManager defaultManager] removeItemAtPath:storePath error:nil];
            _persistentStoreCoordinator = nil;
            _managedObjectModel = nil;
            return [self persistentStoreCoordinator];
            NSLog(@"fileExistsAtPath %@", storePath);
        }
        else {
            abort();
        }
