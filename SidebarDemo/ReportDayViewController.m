...
@interface ReportDayViewController ()

@property (strong) NSArray *objectCat;

@end

@implementation ReportDayViewController
...
- (void)viewDidLoad
{
    ...
    [_dateDay setTitle:_dateString forState:UIControlStateNormal];
    _dateDay.titleLabel.text =_dateString;
    brojac =0;
...
//        if([segue.identifier isEqualToString:@"dayID"]){
